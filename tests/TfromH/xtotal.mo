      ...
      package Common  "Common packages and data for the ideal gas models" 
        ...
        partial package MixtureGasNasa  "Medium model of a mixture of ideal gases based on NASA source" 
          ...
          redeclare function setState_phX  "Return thermodynamic state as function of p, h and composition X" 
            ...
            output ThermodynamicState state;
          algorithm
            assert(false, "calling setState_phX   ==> " + String(p) + "," + String(h) + "," + ThermoS.Util.strVec(X), AssertionLevel.warning);
            ...
            assert(false, "called setState_phX   ==> " + String(p) + "," + String(h) + "," + ThermoS.Util.strVec(X));
            annotation(Inline = false, smoothOrder = 2); 
          end setState_phX;
          ...
          algorithm
            T := 300;
            assert(false, "T_hX Called " + " h  = " + String(h) + "(J/kg)" + " nX = " + String(nX) + " X  = " + ThermoS.Util.strVec(X) + " Xfull  = " + ThermoS.Util.strVec(Xfull), AssertionLevel.warning);
